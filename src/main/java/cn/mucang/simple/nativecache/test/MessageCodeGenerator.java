...
import cn.mucang.simple.nativecache.ignite.Person;
...
public class MessageCodeGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        srcDir = "d://code/project/native-cache/src/main/java/cn/mucang/simple/nativecache/test";
...
//        gen.generateAndWrite(GridH2CacheObject.class);
        System.out.println("path : "+U.getIgniteHome());
    }
